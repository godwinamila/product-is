...
<div id="container">
    ...
    <div id="content-area">
        ...
        <div class="product-box">
            <form method="post" action="identity?SAML2.HTTPBinding=HTTP-POST">
            ...
            <hr/>
            <h2>Click <a href="identity?SAML2.HTTPBinding=HTTP-Redirect">here</a> to login with <img src="images/saml2-logo.png" height="22" width="60"/>
                (Redirect binding) from <img src="images/identity_logo.gif" height="20" width="120"/></h2>
            <hr/>
            <h2>Click <a href="identity?SAML2.HTTPBinding=HTTP-POST">here</a> to login with
